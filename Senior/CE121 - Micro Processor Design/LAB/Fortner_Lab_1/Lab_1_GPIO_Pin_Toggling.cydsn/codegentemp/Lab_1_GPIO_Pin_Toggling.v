// ======================================================================
// Lab_1_GPIO_Pin_Toggling.v generated from TopDesign.cysch
// 10/11/2018 at 17:29
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("999d18e2-3b06-44d5-84b0-c9ced1688ac7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a9640777-e021-4f61-a87e-586af6b82869"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("42503f9c-73e6-4c29-bd62-b2ac309eb0a4"),
		  .source_clock_id(""),
		  .divisor(0),
