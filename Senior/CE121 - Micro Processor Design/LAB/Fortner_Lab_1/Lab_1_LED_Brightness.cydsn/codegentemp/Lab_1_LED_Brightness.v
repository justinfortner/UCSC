// ======================================================================
// Lab_1_LED_Brightness.v generated from TopDesign.cysch
// 10/11/2018 at 17:12
...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("b76c177b-d801-494e-83a5-25cc8e9c7d8b/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("b76c177b-d801-494e-83a5-25cc8e9c7d8b/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("07187086-f82f-4852-8458-0f9b83e4ce16"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Dial_net;
	wire [0:0] tmpFB_0__Dial_net;
	wire [0:0] tmpIO_0__Dial_net;
	wire [0:0] tmpINTERRUPT_0__Dial_net;
	electrical [0:0] tmpSIOVREF__Dial_net;
	...
	cy_psoc3_pins_v1_10
		...
		Dial
		 (.oe(tmpOE__Dial_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Dial_net[0:0]}),
		  .analog({Net_74}),
		  .io({tmpIO_0__Dial_net[0:0]}),
		  .siovref(tmpSIOVREF__Dial_net),
		  .interrupt({tmpINTERRUPT_0__Dial_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Dial_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
